module.exports = {
    ...
    async execute(sock, m) {
        ...
        if (!m.isBotAdmin) return m.reply('❌ I need to be an admin to kick members.');
        let target = null;
        ...
        await sock.sendMessage(m.from, { text: `✅ @${target.split('@')[0]} has been kicked from the group.`, mentions: [target] });
        await m.react('✅');
    }
};